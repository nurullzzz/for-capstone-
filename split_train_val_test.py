...
file_list = jpg_file_list + JPG_file_list + jpeg_file_list 
file_num = len(file_list)
print('Total images: %d' % file_num)

# Determine number of files to move to each folder
train_percent = 0.80  # 80% of the files go to train
val_percent = 0.19 # 10% go to validation
test_percent = 0.01 # 10% go to test
